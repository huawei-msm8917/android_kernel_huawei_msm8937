...
extern int hi846_synology_1p0j0_pad_otp_func(struct msm_sensor_ctrl_t *s_ctrl,int index);

extern int hi553_jsl_selina_otp_func(struct msm_sensor_ctrl_t *s_ctrl,int index);

extern void  gc5025_kingcome_selina_otp_func(struct msm_sensor_ctrl_t *s_ctrl);

extern int s5k5e8_blx_selina_otp_func(struct msm_sensor_ctrl_t * s_ctrl, int index);
