...
#define HI843_QTECH_FH843_PAD_OTP_VCM_OFFSET_VALUE (50)
#define HI843_QTECH_FH843_PAD_MACRO_MAX 1023
...
static int hi843_qtech_fh843_pad_otp_get_af(struct msm_sensor_ctrl_t* s_ctrl,st_reg_addr  af_addr)
{
	...
	hi843_qtech_fh843_pad_otp_info.infinity_dac = (buf[1]  << 8) | buf[2];
	hi843_qtech_fh843_pad_otp_info.macro_dac = (buf[3]  << 8) | buf[4];
       if((0 == hi843_qtech_fh843_pad_otp_info.infinity_dac) || (0 == hi843_qtech_fh843_pad_otp_info.macro_dac) ||
	    (hi843_qtech_fh843_pad_otp_info.macro_dac <= hi843_qtech_fh843_pad_otp_info.infinity_dac))
	{
		CMR_LOGE("hi843_qtech_fh843_pad_otp_info.infinity_dac = 0x%x\n", hi843_qtech_fh843_pad_otp_info.infinity_dac);
		CMR_LOGE("hi843_qtech_fh843_pad_otp_info.macro_dac = 0x%x\n", hi843_qtech_fh843_pad_otp_info.macro_dac);
	       return -1;
	}
	if(hi843_qtech_fh843_pad_otp_info.infinity_dac <= HI843_QTECH_FH843_PAD_OTP_VCM_OFFSET_VALUE)
	{
		hi843_qtech_fh843_pad_otp_info.infinity_dac = 1;
	}
	else
	{
		hi843_qtech_fh843_pad_otp_info.infinity_dac -= HI843_QTECH_FH843_PAD_OTP_VCM_OFFSET_VALUE;
	}
	hi843_qtech_fh843_pad_otp_info.macro_dac += HI843_QTECH_FH843_PAD_OTP_VCM_OFFSET_VALUE;
	if(hi843_qtech_fh843_pad_otp_info.macro_dac >= HI843_QTECH_FH843_PAD_MACRO_MAX)
	{
            hi843_qtech_fh843_pad_otp_info.macro_dac = HI843_QTECH_FH843_PAD_MACRO_MAX;
	}
